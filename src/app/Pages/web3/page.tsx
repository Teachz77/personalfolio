...
export default function Web3Page(){
    ...
    const projects = [
        {
            name: "CertNFT",
            description: "An application for managing NFT-based digital certificates because the certificates or documents have been stored on the Solana blockchain in the form of NFTs.",
            techStack: ["Anchor", "Rust", "React.js", "Typescript"],
            githubUrl: "https://github.com/Teachz77/CerNFT-App",
            liveUrl: "https://certnft.vercel.app/",
            image: "/mockup3.png",
            imageAlt: "CertNFT",
        }
    ];
